...
class Captcha{
    ...
    private ?GdImage $im  = null; // 验证码图片实例
    private ?int $color   = null; // 验证码字体颜色
    /**
     * 构造方法 设置参数
     * @access public
    ...
    public function create(string $id = ''){
        ...
        Cache::put($key . $id, $secode, $this->expire + $secode['verify_time']);
        ...
        return Response::make($content, 200, ['Content-Length' => strlen($content)])->header('Content-Type', 'image/png');
    }
